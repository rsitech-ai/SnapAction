...
The owner explicitly authorized publication, RSI Tech naming/maintenance, the license, contribution model, security intake, and a coordinated Git-history rewrite to the approved noreply identity. The formal Codex Security scan was intentionally skipped and accepted as residual risk; it is not represented as completed.
