...
| --- | --- | --- |
| Current tree | Source, tests, community build configuration, documentation, generated evidence | Local signing credentials and official identity files are ignored; tracked workstation-specific paths still require cleanup or acceptance. |
