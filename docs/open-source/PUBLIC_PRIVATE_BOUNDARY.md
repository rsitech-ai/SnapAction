...
| Sanitized published Git history using the approved maintainer noreply email and GitHub service noreply identities | Workstation paths, personal email addresses, internal agent plans/reflections, `.cursor/`, `.codex/` |
